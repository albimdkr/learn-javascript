...
regularMethodPerson1.setSkill = 'HTML';
regularMethodPerson1.setSkill = 'CSS';
regularMethodPerson1.setSkill = 'JavaScript';

console.log(regularMethodPerson1.getScore);
console.log(regularMethodPerson1.getSkills);
console.log(regularMethodPerson1.getPersonInfo());
